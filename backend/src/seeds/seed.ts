...
const seedDatabase = async () => {
  try {
    ...
    const categories = await Category.create([
      { name: 'Smartphones', slug: 'smartphones', image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=400&fit=crop', description: 'Latest smartphones', productCount: 0 },
      { name: 'Feature Phones', slug: 'feature-phones', image: 'https://images.unsplash.com/photo-1595941069915-4ebc5197c14a?w=400&h=400&fit=crop', description: 'Reliable feature phones', productCount: 0 },
      { name: 'Refurbished Phones', slug: 'refurbished-phones', image: 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=400&h=400&fit=crop', description: 'Quality checked refurbished smartphones', productCount: 0 },
      { name: 'Keypad Phones', slug: 'keypad-phones', image: 'https://images.unsplash.com/photo-1589492477829-5e65395b66cc?w=400&h=400&fit=crop', description: 'Classic keypad mobile phones', productCount: 0 },
      { name: 'Chargers', slug: 'chargers', image: 'https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=400&h=400&fit=crop', description: 'Fast chargers and adapters', productCount: 0 },
      { name: 'Charging Cables', slug: 'charging-cables', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=400&fit=crop', description: 'USB-C, Lightning & Micro USB cables', productCount: 0 },
      { name: 'Headphones', slug: 'headphones', image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop', description: 'Wired and wireless headphones', productCount: 0 },
      { name: 'Bluetooth Headsets', slug: 'bluetooth-headsets', image: 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=300&h=300&fit=crop', description: 'Wireless Bluetooth earbuds and headsets', productCount: 0 },
      { name: 'Bluetooth Speakers', slug: 'bluetooth-speakers', image: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop', description: 'Portable Bluetooth speakers', productCount: 0 },
      { name: 'Batteries', slug: 'batteries', image: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400&h=400&fit=crop', description: 'Replacement mobile batteries', productCount: 0 },
      { name: 'Tempered Glass', slug: 'tempered-glass', image: 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=400&h=400&fit=crop', description: 'Screen protectors and tempered glass', productCount: 0 },
      { name: 'Mouse', slug: 'mouse', image: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=400&h=400&fit=crop', description: 'Wired and wireless mouse', productCount: 0 },
      { name: 'SIM Cards', slug: 'sim-cards', image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400&h=400&fit=crop', description: 'Prepaid and postpaid SIM cards', productCount: 0 },
      { name: 'Accessories', slug: 'accessories', image: 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=400&h=400&fit=crop', description: 'Mobile accessories', productCount: 0 },
      { name: 'Tablets', slug: 'tablets', image: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400&h=400&fit=crop', description: 'Tablets and iPads', productCount: 0 },
    ]);
    ...
    const products = await Product.create([
      {
        ...
        discount: 4,
        images: ['https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1678685888221-cda773a3dcdb?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1707227156456-56ab57a9e5c5?w=600&h=600&fit=crop'],
      ...
      },
      {
        ...
        discount: 0,
        images: ['https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1696446702183-cbd13d78e1e7?w=600&h=600&fit=crop'],
        thumbnail: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=300&h=300&fit=crop',
        specifications: {
      ...
      },
      {
        ...
        originalPrice: 69999,
        discount: 7,
        images: ['https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1605236453806-6ff36851218e?w=600&h=600&fit=crop'],
      ...
      },
      {
        ...
        originalPrice: 54999,
        discount: 9,
        images: ['https://images.unsplash.com/photo-1592950630581-03cb41342cc5?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=600&h=600&fit=crop'],
        thumbnail: 'https://images.unsplash.com/photo-1592950630581-03cb41342cc5?w=300&h=300&fit=crop',
        specifications: {
      ...
      },
      {
        ...
        originalPrice: 25999,
        discount: 8,
        images: ['https://images.unsplash.com/photo-1598965402089-897ce52e8355?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1605236453806-6ff36851218e?w=600&h=600&fit=crop'],
        thumbnail: 'https://images.unsplash.com/photo-1598965402089-897ce52e8355?w=300&h=300&fit=crop',
        specifications: {
      ...
      },
      {
        ...
        originalPrice: 25999,
        discount: 15,
        images: ['https://images.unsplash.com/photo-1565849904461-04a58ad377e0?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1512054502232-10a0a035d672?w=600&h=600&fit=crop'],
        thumbnail: 'https://images.unsplash.com/photo-1565849904461-04a58ad377e0?w=300&h=300&fit=crop',
        specifications: {
          display: 'LTPO AMOLED, 120Hz',
      ...
      },
      {
        ...
        originalPrice: 39999,
        discount: 15,
        images: ['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1580910051074-3eb694886f3b?w=600&h=600&fit=crop'],
      ...
      },
      {
        ...
        originalPrice: 32999,
        discount: 18,
        images: ['https://images.unsplash.com/photo-1556656793-08538906a9f8?w=600&h=600&fit=crop', 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&h=600&fit=crop'],
        thumbnail: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=300&h=300&fit=crop',
        specifications: {
    ...
    const banners = await Banner.create([
      {
        ...
        image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=1200&h=400&fit=crop',
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=1200&h=400&fit=crop',
