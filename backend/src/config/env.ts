...
const envSchema = z.object({
  ...
  CORS_ORIGIN: z.string().default('http://localhost:3002,http://localhost:3003,https://amohamobiles.com,https://www.amohamobiles.com,https://admin.amohamobiles.com,https://amoha-frontend.vercel.app,https://amoha-admin-seven.vercel.app'),
